            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        @if (auth()->user()->role == 'Admin')
                            <li>
                                <a href="{{ url('/kelola_data_koordinator') }}"
                                    class="waves-effect {{ request()->is('/kelola_data_koordinator') ? 'active' : '' }}">
                        ...
                        @if (auth()->user()->role == 'Admin')
                            <li>
                                <a href="{{ url('/kelola_data_kepala_bagian') }}"
                                    class="waves-effect {{ request()->is('/kelola_data_kepala_bagian') ? 'active' : '' }}">
                                    <i class="fa fa-users"></i>
                        ...
                        @if (auth()->user()->role == 'Koordinator')
                            <li>
                                <a href="{{ url('/kelola_data_petugas') }}"
                                    class="waves-effect {{ request()->is('/kelola_data_petugas') ? 'active' : '' }}">
                                    <i class="fa fa-users"></i>
                        ...
                        @if (auth()->user()->role == 'Admin')
                            <li>
                                <a href="{{ url('/kelola_loket_pelayanan') }}"
                                    class="waves-effect {{ request()->is('/kelola_loket_pelayanan') ? 'active' : '' }}">
                                    <i class="fa fa-cog"></i>
                            ...
                            @if (auth()->user()->petugas->loket_pelayanan_id == 0)
                                <li class="has_sub">
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="{{ request()->is('/antrian_a') ? 'active' : '' }}"><a
                                                href="{{ url('/antrian_a') }}">Loket A</a></li>
                                        <li class="{{ request()->is('/antrian_b') ? 'active' : '' }}"><a
                                                href="{{ url('/antrian_b') }}">Loket B</a></li>
                                        <li class="{{ request()->is('/antrian_c') ? 'active' : '' }}"><a
                                                href="{{ url('/antrian_c') }}">Loket C</a></li>
                        ...
                        @if (auth()->user()->role == 'Petugas')
                            @if (auth()->user()->petugas->loket_pelayanan_id != 0)
                                ...
                                @if (auth()->user()->petugas->loket_pelayanan_id == 1)
                                    <li><a href="/pelayanan_a"
                                            class="waves-effect {{ request()->is('/pelayanan_a') ? 'active' : '' }}"><i
                                                class="fa fa-desktop"></i><span> Loket Pelayanan A </span></a></li>
                                @endif
                                {{-- <li><a href="">{{ auth()->user()->petugas->id }}</a></li> --}}
                                @if (auth()->user()->petugas->loket_pelayanan_id == 2)
                                    <li><a href="/pelayanan_b"
                                            class="waves-effect {{ request()->is('/pelayanan_b') ? 'active' : '' }}"><i
                                                class="fa fa-desktop"></i><span> Loket Pelayanan B </span></a></li>
                                @endif
                                @if (auth()->user()->petugas->loket_pelayanan_id == 3)
                                    <li><a href="/pelayanan_c"
                                            class="waves-effect {{ request()->is('/pelayanan_c') ? 'active' : '' }}"><i
                                                class="fa fa-desktop"></i><span> Loket Pelayanan C </span></a></li>
                                @endif
                                @if (auth()->user()->petugas->loket_pelayanan_id == 4)
                                    <li><a href="/pelayanan_d"
                                            class="waves-effect {{ request()->is('/pelayanan_d') ? 'active' : '' }}"><i
                                                class="fa fa-desktop"></i><span> Loket Pelayanan D </span></a></li>
                                @endif
                                {{-- </ul> --}}
                                {{-- </li> --}}
                            @endif
                        ...
                        @if (auth()->user()->role == 'Koordinator')
                            <li>
                                <a href="{{ url('/kelola_lama_pelayanan') }}"
                                    class="waves-effect {{ request()->is('/kelola_lama_pelayanan') ? 'active' : '' }}">
                        ...
                        @if (auth()->user()->role == 'Kepala Bagian')
                            <li>
                                <a href="{{ url('/multi_channel_single_phase') }}"
                                    class="waves-effect {{ request()->is('/multi_channel_single_phase') ? 'active' : '' }}">
                        ...
                        @if (auth()->user()->role == 'Kepala Bagian')
                            <li>
                                <a href="{{ url('/laporan') }}"
                                    class="waves-effect {{ request()->is('/laporan') ? 'active' : '' }}">
                        ...
                        <ul class="list-inline float-right mb-0">
                            ...
                            <li class="list-inline-item dropdown notification-list">
                                <a style="color: white"
                                    ...
                                    aria-expanded="false">
                                    {{ auth()->user()->role }} &nbsp; <img
                                        src="{{ asset('assets/images/logosintang.png') }}" alt="user"
