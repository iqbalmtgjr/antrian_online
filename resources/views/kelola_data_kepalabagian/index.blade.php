    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Kelola Data Kepala Bagian</h4>
            </div>
        </div>
    </div>
    <div class="row">
                ...
                <div class="card-body">
                    <table id="datatable" class="table table-striped">
                        <a href="" class="btn btn-primary btn-md m-l-15 m-b-15" data-toggle="modal" data-target="#tambah"><i
                            ...
                            Tambah</a>
                        @include('kelola_data_kepalabagian/modaltambah')
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>NIP</th>
        ...
        $('.delete').click(function() {
            ...
            Swal.fire({
                ...
                .then((result) => {
                    console.log(result);
                    if (result.value) {
                        window.location = "/kepala_bagian/hapus/" + Id + "";
                    }
                });
        });
        ...
        $('.resetpassword').click(function() {
            ...
            Swal.fire({
                ...
                .then((result) => {
                    console.log(result);
                    if (result.value) {
                        window.location = "/resetpassword/kepala_bagian/" + Id + "";
                    }
                });
        });
