                    ...
                    <div id="result">
                        <table id="" class="table">
                            <div class="row">
                                ...
                                <a href="{{ url('/antrian/cetak_c') }}" class="btn btn-primary btn-md ml-3 mb-3 ">
                                        ...
                                        <center>
                                            ...
                                            @else
                                                <h2>
                                                    @if ($data->count() == 0)
                                                        @if ($data->count() == 0 &&
        App\Models\Laporan::where('id_pelayanan', 3)->where('tgl_antrian', $tgl)->get()->count() == 0)
                                                            C0{{ $data->count() + 1 }}
                                                        @else
                                                    ...
                                                    @elseif (App\Models\Antrian::where('id_pelayanan', 3)->count() < 1)
                                                        C0{{ $data->count() + 1 }} @else @if (App\Models\Antrian::where('id_pelayanan', 3)->get()->last()->no_antrian >= 9)
                                                            C{{ App\Models\Antrian::where('id_pelayanan', 3)->get()->last()->no_antrian + 1 }}
                                                        @else
