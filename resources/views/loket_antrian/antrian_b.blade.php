                                ...
                                <form action="{{ url('/antrian/lanjut/b') }}" method="post">
                                    ...
                                    <center>
                                        ...
                                        @else
                                            <h2>
                                                @if ($data->count() == 0)
                                                    @if($data->count() == 0 && App\Models\Laporan::where('id_pelayanan', 2)->where('tgl_antrian', $tgl)->get()->count() == 0)
                                                    B0{{ $data->count() + 1 }}
                                                    @else
                                                ...
                                                @else
                                                    ...
                                                    ->get()
                                                    ->last()->no_antrian >= 9) B{{ App\Models\Antrian::where('id_pelayanan', 2)->get()->last()->no_antrian + 1 }}
                                                    @else
