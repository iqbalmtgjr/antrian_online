    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Loket Pelayanan C</h4>
                <form action="">
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    <a href="#" class="btn btn-primary btn-md m-l-15 m-b-15" data-toggle="modal"
                        ...
                        Mulai/Lanjut</a> <br>
                    <form action="{{ url('/pelayanan_c') }}" method="GET">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Pelayanan Loket C</h5>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('/pelayanan/lanjut/c') }}" method="post">
                                                @csrf
                                                <center>
                                                    @if ($data->count() >= 9)
                                                        <h2>
                                                            C{{ App\Models\Antrian::where('id_pelayanan', 3)->first()->no_antrian + 1 }}

                                                        </h2>
                                                    @else
                                                        <h2>
                                                            @if (App\Models\Antrian::where('id_pelayanan', 3)->get()->count() <= 1)
                                                                -
                                                            @else
                                                                @if (App\Models\Antrian::where('id_pelayanan', 3)->first()->no_antrian >= 9)
                                                                    C{{ App\Models\Antrian::where('id_pelayanan', 3)->first()->no_antrian + 1 }}
                                                                @else
    ...
    <script>
        $(document).ready(function() {
            setInterval(function() {
                $('#result').load("pelayanan_c #result");
            }, 3000);
        });
    </script>
@endsection
